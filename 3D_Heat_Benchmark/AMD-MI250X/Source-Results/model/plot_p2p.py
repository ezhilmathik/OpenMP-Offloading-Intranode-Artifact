...
Usage:
python3 plot_p2p.py --gamma 13.584e-11 --gpus 2 --beta-p2p 61.28 --residuals                                                                                                                                  
python3 plot_p2p.py --gamma 13.584e-11 --gpus 4 --beta-p2p 61.28 --residuals   
...
def main():
    ...
    out = args.out or f"mi250x_p2p_{P}gpu"
