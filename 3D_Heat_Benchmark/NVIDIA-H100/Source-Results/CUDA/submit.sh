...
# for every grid size. NVIDIA H100 (sm_90) CUDA / MareNostrum 5 acc.
# ---------------------------------------------------------------------------
#
...
echo "============================================================"
echo "Submitting 3D-heat CUDA timing pipeline  (NVIDIA H100 / MareNostrum 5)"
echo "============================================================"
...
MISSING=()
for b in 1-cuda 2-cuda 2-cuda-stream 2-cuda-stream-omp 2-cuda-stream-omp-p2p \
         4-cuda 4-cuda-stream 4-cuda-stream-omp 4-cuda-stream-omp-p2p; do
    [[ -x "./$b" ]] || MISSING+=("$b")
done
