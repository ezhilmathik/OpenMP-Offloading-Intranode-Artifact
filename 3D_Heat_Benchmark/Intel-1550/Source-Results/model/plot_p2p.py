...
Usage:
    python3 plot_p2p.py --gamma 4.6676e-11 --gpus 2 --beta-p2p 62.85 --residuals
    python3 plot_p2p.py --gamma 4.6676e-11 --gpus 4 --beta-p2p 62.85 --residuals
...
def main():
    ...
    out = args.out or f"1550_p2p_{P}gpu"
