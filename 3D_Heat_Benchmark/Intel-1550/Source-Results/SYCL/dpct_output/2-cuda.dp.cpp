...
/*
DPCT1009:60: SYCL uses exceptions to report errors and does not use the error
...
int main(int argc, char **argv) try {
  ...
  /*
  DPCT1093:61: The "0" device may be not the one intended for use. Adjust the
  ...
  */
  ...
  /*
  DPCT1093:62: The "1" device may be not the one intended for use. Adjust the
  selected device if needed.
  */
  ...
  while (t < T) {
    ...
    /*
    DPCT1093:63: The "0" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    CUDA_CHECK(DPCT_CHECK_ERROR(dpct::select_device(0)));
    /*
    ...
    */
    ...
    /*
    DPCT1093:66: The "1" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    CUDA_CHECK(DPCT_CHECK_ERROR(dpct::select_device(1)));
    /*
  ...
  /*
  DPCT1093:73: The "0" device may be not the one intended for use. Adjust the
  selected device if needed.
  */
  CUDA_CHECK(DPCT_CHECK_ERROR(dpct::select_device(0))); CUDA_CHECK(
      DPCT_CHECK_ERROR(dpct::get_current_device().queues_wait_and_throw()));
  /*
  DPCT1093:74: The "1" device may be not the one intended for use. Adjust the
  selected device if needed.
  */
  ...
  /*
  DPCT1093:75: The "0" device may be not the one intended for use. Adjust the
  selected device if needed.
  */
  CUDA_CHECK(DPCT_CHECK_ERROR(dpct::select_device(0)));
  CUDA_CHECK(DPCT_CHECK_ERROR(
  ...
  /*
  DPCT1093:76: The "1" device may be not the one intended for use. Adjust the
  selected device if needed.
  */
  CUDA_CHECK(DPCT_CHECK_ERROR(dpct::select_device(1)));
  CUDA_CHECK(DPCT_CHECK_ERROR(
  ...
  if (should_write_txt())
    write_u_values("u_cuda_2gpu.txt", h_u_global, n);

  // -- Cleanup ---------------------------------------------------
  /*
  DPCT1093:77: The "0" device may be not the one intended for use. Adjust the
  selected device if needed.
  */
  CUDA_CHECK(DPCT_CHECK_ERROR(dpct::select_device(0)));
  CUDA_CHECK(
  ...
  /*
  DPCT1093:78: The "1" device may be not the one intended for use. Adjust the
  selected device if needed.
  */
  CUDA_CHECK(DPCT_CHECK_ERROR(dpct::select_device(1)));
  CUDA_CHECK(
