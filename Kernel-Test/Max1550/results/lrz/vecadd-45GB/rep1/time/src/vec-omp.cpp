...
//
// Counterpart of vec-cuda.cu: same N, same values (A = 1, B = i), same timing
// (one warm-up call, then the mean wall time of `reps` blocking calls), and
// every element checked against the CPU.
