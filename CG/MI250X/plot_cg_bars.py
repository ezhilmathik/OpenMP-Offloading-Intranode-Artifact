#!/usr/bin/env python3
"""
plot_cg_bars.py — CG full-cycle time, CPU vs OpenMP offloading (A100, MeluXina)
...
#    ("cpu",         "CPU (128 threads)",        "grey", "//"),
    ("ompgpu1",     "OpenMP Off. (1 GCD)",      "b",    "//"),
    ("ompgpu2halo", "OpenMP Off. (2 GCDs)", "g",   None),
    ("ompgpu4halo", "OpenMP Off. (4 GCDs)", "orange",   None),
]
...
#TITLE         = "AMD Instinct MI250X - CG (fp64, natural ordering)"
#TITLE = ("AMD Instinct MI250X - CG (fp64, CSR, mean 16 nnz/row, natural ordering, "
#         r"$\|r\|/\|b\| \leq 10^{-8}$)")

TITLE = ("AMD MI250X (1 GCD/module) - CG "
         r"(fp64, CSR, mean 16 nnz/row, $\|r\|/\|b\| \leq 10^{-8}$)")
...
def main():
    ...
    plot_chart(med, gbs, os.path.join(args.outdir, "CG_MI250X_halo.pdf"),
