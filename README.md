...
Artifact accompanying the paper *Evaluating OpenMP Offloading for Intranode Multi-GPU Programming on NVIDIA, AMD, and Intel GPUs: A 3D Heat Transfer Case Study*.
