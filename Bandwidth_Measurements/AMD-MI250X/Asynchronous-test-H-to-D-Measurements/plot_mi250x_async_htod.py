#!/usr/bin/env python3
"""
plot_htod.py — Bandwidth vs transferred size for versions v1, v2
               (Async H-to-D transfer, LUMI / MI250X)
...
OUTPUT_NAME      = "mi250x_async_htod.pdf"
...
GAP_DIRECTION    = "HtoD"         # label shown in the box header
...
def main():
    ...
    ax1.set_title("AMD MI250X (1 GCD) - HtoD: asynchronous", fontsize=16, fontweight="bold", pad=12)
    ...
    #    v1 -> 36 GB/s   (one H-to-D link)    blue
    #    v2 -> 72 GB/s   (two H-to-D links in parallel)   green
