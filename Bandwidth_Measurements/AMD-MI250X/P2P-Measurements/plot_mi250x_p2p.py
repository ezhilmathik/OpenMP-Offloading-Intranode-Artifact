#!/usr/bin/env python3
"""
plot_p2p.py — Bandwidth vs transferred size for versions v1, v2, v4
              (P2P transfer, H100)
...
# GAP_BASELINE_FW must match a framework key present in the CSVs ("hip" on
# MI250X, "cuda" on H100). If it isn't present for a version, that line is
...
GAP_BASELINE_FW  = "hip"          # native framework compared against omp_off
...
def main():
    ...
    ax1.set_title("AMD MI250X (1 GCD) - P2P", fontsize=16, fontweight="bold", pad=12)
