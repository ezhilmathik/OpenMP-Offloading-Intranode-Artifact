# Asynchronous Device-to-Host Bandwidth — AMD MI250X
...
|---|---|---|
| `v1` | Asynchronous transfer from a single GCD to host | 36 GB/s |
| `v2` | Concurrent asynchronous transfer from two GCDs on separate cards | 72 GB/s |
...
`plot_mi250x_async_dtoh.py` and drawn as dashed reference lines.
...
| `plot_mi250x_async_dtoh.py` | Aggregates all runs and produces the paper figure |
...
|---|---|---|---|
| *[Figure N]*: OpenMP offload vs HIP, async D-to-H on MI250X | `python3 plot_mi250x_async_dtoh.py` | seconds, no GPU needed | `plots_final/mi250x_async_dtoh.pdf` |
