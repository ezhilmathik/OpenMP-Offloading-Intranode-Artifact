# Synchronous Device-to-Host Bandwidth — AMD MI250X
...
|---|---|---|
| `v1` | Transfer from a single GCD to host | 36 GB/s |
| `v2` | Concurrent transfer from two GCDs on separate cards | 72 GB/s |
...
`plot_mi250x_sync_dtoh.py` and drawn as dashed reference lines.
...
| `plot_mi250x_sync_dtoh.py` | Aggregates all runs and produces the paper figure |
...
|---|---|---|---|
| *[Figure N]*: OpenMP offload vs HIP, sync D-to-H on MI250X | `python3 plot_mi250x_sync_dtoh.py` | seconds, no GPU needed | `plots_final/mi250x_sync_dtoh.pdf` |
