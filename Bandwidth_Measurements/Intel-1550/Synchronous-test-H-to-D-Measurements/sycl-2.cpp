...
int main(int argc, char *argv[]) {
    ...
    */
    ...
    #pragma omp parallel sections
    {
        ...
        {
            /*
            DPCT1093:8: The "0" device may be not the one intended for use.
        ...
        {
            /*
            DPCT1093:9: The "1" device may be not the one intended for use.
            Adjust the selected device if needed.
            */
    ...
    */
    ...
    free(h_verifyA); free(h_verifyB);
    /*
    DPCT1093:14: The "0" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    checkCuda(DPCT_CHECK_ERROR(dpct::select_device(0)), "cudaSetDevice 0");
        checkCuda(
            ...
            "cudaFree d_A");
    /*
    DPCT1093:15: The "1" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    checkCuda(DPCT_CHECK_ERROR(dpct::select_device(1)), "cudaSetDevice 1");
        checkCuda(
