...
int main(int argc, char *argv[]) {
    ...
    */
    ...
    if (!h_verifyA || !h_verifyB || !h_verifyC || !h_verifyD) {
        ...
        /*
        DPCT1093:21: The "0" device may be not the one intended for use. Adjust
        the selected device if needed.
        */
        checkCuda(DPCT_CHECK_ERROR(dpct::select_device(0)), "cudaSetDevice 0");
            checkCuda(DPCT_CHECK_ERROR(
                      ...
                      "cudaFree d_A");
        /*
        DPCT1093:22: The "1" device may be not the one intended for use. Adjust
        the selected device if needed.
        */
        checkCuda(DPCT_CHECK_ERROR(dpct::select_device(1)), "cudaSetDevice 1");
            checkCuda(DPCT_CHECK_ERROR(
                      ...
                      "cudaFree d_B");
        /*
        DPCT1093:23: The "2" device may be not the one intended for use. Adjust
        the selected device if needed.
        */
        checkCuda(DPCT_CHECK_ERROR(dpct::select_device(2)), "cudaSetDevice 2");
            checkCuda(DPCT_CHECK_ERROR(
                      ...
                      "cudaFree d_C");
        /*
        DPCT1093:24: The "3" device may be not the one intended for use. Adjust
        the selected device if needed.
        */
        checkCuda(DPCT_CHECK_ERROR(dpct::select_device(3)), "cudaSetDevice 3");
            checkCuda(DPCT_CHECK_ERROR(
    ...
    /*
    DPCT1093:25: The "0" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    checkCuda(DPCT_CHECK_ERROR(dpct::select_device(0)), "cudaSetDevice 0");
    checkCuda(DPCT_CHECK_ERROR(dpct::get_in_order_queue()
              ...
              "verify d_A");
    /*
    DPCT1093:26: The "1" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    checkCuda(DPCT_CHECK_ERROR(dpct::select_device(1)), "cudaSetDevice 1");
    checkCuda(DPCT_CHECK_ERROR(dpct::get_in_order_queue()
              ...
              "verify d_B");
    /*
    DPCT1093:27: The "2" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    checkCuda(DPCT_CHECK_ERROR(dpct::select_device(2)), "cudaSetDevice 2");
    checkCuda(DPCT_CHECK_ERROR(dpct::get_in_order_queue()
              ...
              "verify d_C");
    /*
    DPCT1093:28: The "3" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    checkCuda(DPCT_CHECK_ERROR(dpct::select_device(3)), "cudaSetDevice 3");
    checkCuda(DPCT_CHECK_ERROR(dpct::get_in_order_queue()
    ...
    free(h_verifyA); free(h_verifyB); free(h_verifyC); free(h_verifyD);
    /*
    DPCT1093:29: The "0" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    checkCuda(DPCT_CHECK_ERROR(dpct::select_device(0)), "cudaSetDevice 0");
        checkCuda(
            ...
            "cudaFree d_A");
    /*
    DPCT1093:30: The "1" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    checkCuda(DPCT_CHECK_ERROR(dpct::select_device(1)), "cudaSetDevice 1");
        checkCuda(
            ...
            "cudaFree d_B");
    /*
    DPCT1093:31: The "2" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    checkCuda(DPCT_CHECK_ERROR(dpct::select_device(2)), "cudaSetDevice 2");
        checkCuda(
            ...
            "cudaFree d_C");
    /*
    DPCT1093:32: The "3" device may be not the one intended for use. Adjust the
    selected device if needed.
    */
    checkCuda(DPCT_CHECK_ERROR(dpct::select_device(3)), "cudaSetDevice 3");
        checkCuda(
