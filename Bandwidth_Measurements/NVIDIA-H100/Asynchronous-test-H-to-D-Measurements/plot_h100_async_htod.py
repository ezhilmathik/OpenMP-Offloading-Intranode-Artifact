#!/usr/bin/env python3
"""
plot_async_htod.py — Bandwidth vs transferred size for versions v1, v2
                    (Async H-to-D transfer, H100)
...
OUTPUT_NAME      = "h100_async_htod.pdf"
...
GAP_TEXTBOX_LOC  = (0.02, 0.2)   # axis fraction; (x, y), bottom-left origin
...
#    ax1.set_title("NVIDIA H100", fontsize=16, fontweight="bold", pad=12)
    ax1.set_title("NVIDIA H100 - HtoD: asynchronous", fontsize=16, fontweight="bold", pad=12)
