#!/usr/bin/env python3
"""
plot_async_dtoh.py — Bandwidth vs transferred size for versions v1, v2
                    (Async D-to-H transfer, H100)
...
OUTPUT_NAME      = "h100_async_dtoh.pdf"
...
GAP_TEXTBOX_LOC  = (0.02, 0.20)   # axis fraction; (x, y), bottom-left origin
...
#    ax1.set_title("NVIDIA H100", fontsize=16, fontweight="bold", pad=12)
    ax1.set_title("NVIDIA H100 - DtoH: asynchronous", fontsize=16, fontweight="bold", pad=12)
