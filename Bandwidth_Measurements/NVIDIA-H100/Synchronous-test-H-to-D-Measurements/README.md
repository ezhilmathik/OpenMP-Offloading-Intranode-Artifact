# Synchronous Host-to-Device Bandwidth — NVIDIA H100
...
|---|---|---|
| `v1` | Transfer to a single GPU | 64 GB/s (PCIe Gen5 x16) |
| `v2` | Concurrent transfer to two GPUs | 128 GB/s |
...
| `version-1.cu`, `version-2.cu` | Equivalent native CUDA implementations |
...
| `plot_h100_sync_htod.py` | Aggregates all runs and produces the paper figure |
...
|---|---|---|---|
| *[Figure N]*: OpenMP offload vs CUDA, sync H-to-D on H100 | `python plot_h100_sync_htod.py` | seconds, no GPU needed | `plots_final/h100_sync_htod.pdf` |
